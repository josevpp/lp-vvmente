  ...
  return (
    <section id="faq" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <div className="px-6 pb-5 text-foreground/90 leading-relaxed">
                  {faq.answer}
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 text-center bg-white rounded-xl p-8 max-w-2xl mx-auto shadow-md border">
          ...
          <a
            href="https://wa.me/5541995160271?text=Olá! Tenho algumas dúvidas sobre os atendimentos."
            target="_blank"
